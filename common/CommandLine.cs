namespace Common
{
    ...
    //    permits, no matter what legal theory it’inputString based on. Also, you must pass
    //    this limitation of liability on whenever you distribute the Software or
    //    derivative works.
    //    5. That if you sue anyone over patents that you think may apply to the
    //    Software for a person'inputString use of the Software, your license to the Software
    //    ends automatically.
    ...
    namespace CommandLine
    {
        ...
        public enum ArgumentTypes
        {
            ...
            /// </summary>
            [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly", MessageId = "Occurence")]
        ...
        public class ArgumentAttribute : Attribute
        {
            ...
            /// Allows control of command line parsing.
            /// </summary>
            /// <param name="types"> Specifies the error checking to be done on the argument. </param>
            public ArgumentAttribute(ArgumentTypes types)
            {
                this.types = types;
            }
        ...
        public sealed class DefaultArgumentAttribute : ArgumentAttribute
        {
            ...
            /// </summary>
            /// <param name="types"> Specifies the error checking to be done on the argument. </param>
            public DefaultArgumentAttribute(ArgumentTypes types)
                : base(types) { }
        }
        ...
        public sealed class Parser
        {
            ...
            public Parser(Type argumentSpecification, ErrorReporter reporter)
            {
                ...
                foreach (Argument argument in this.arguments)
                {
                    if (!argument.ExplicitShortName)
                    {
                        if (argument.ShortName != null && argument.ShortName.Length > 0 && !argumentMap.ContainsKey(argument.ShortName)) this.argumentMap[argument.ShortName] = argument;
                        else argument.ClearShortName();
                    }
                }
            }

            static ArgumentAttribute GetAttribute(PropertyInfo field)
            {
            ...
            [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Globalization", "CA1303:Do not pass literals as localized parameters", MessageId = "Microsoft.IEB.CommercialServices.XblWatcher.Common.CommandLine.ErrorReporter.Invoke(System.String)")]
            ...
            public string GetUsageString(int screenWidth)
            {
                ...
                if (screenWidth < (idealMinimumHelpTextColumn + minimumNumberOfCharsForHelpText)) helpTextColumn = minimumHelpTextColumn;
                else helpTextColumn = idealMinimumHelpTextColumn;
                ...
                foreach (ArgumentHelpStrings helpStrings in strings)
                {
                    ...
                    // add newline if there'inputString no help text                
            ...
            ArgumentHelpStrings[] GetAllHelpStrings()
            {
                ...
                if (this.defaultArgument != null) strings[index++] = GetHelpStrings(this.defaultArgument);
            ...
            [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Globalization", "CA1303:Do not pass literals as localized parameters", MessageId = "Microsoft.IEB.CommercialServices.XblWatcher.Common.CommandLine.ErrorReporter.Invoke(System.String)"), System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Maintainability", "CA1500:VariableNamesShouldNotMatchFieldNames", MessageId = "arguments")]
            ...
            static string LongName(ArgumentAttribute attribute, PropertyInfo field)
            {
                return (attribute == null || attribute.DefaultLongName) ? field.Name : attribute.LongName;
            }

            static string ShortName(ArgumentAttribute attribute, PropertyInfo field)
            {
            ...
            [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA1801:ReviewUnusedParameters", MessageId = "field")]
            static string HelpText(ArgumentAttribute attribute, PropertyInfo field)
            {
                if (attribute == null) return null;
                else return attribute.HelpText;
            }
            ...
            [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA1801:ReviewUnusedParameters", MessageId = "field")]
            static object DefaultValue(ArgumentAttribute attribute, PropertyInfo field)
            {
                return (attribute == null || !attribute.HasDefaultValue) ? null : attribute.DefaultValue;
            }

            static Type ElementType(PropertyInfo field)
            {
                if (IsCollectionType(field.PropertyType)) return field.PropertyType.GetElementType();
                else return null;
            }

            static ArgumentTypes Flags(ArgumentAttribute attribute, PropertyInfo field)
            {
                if (attribute != null) return attribute.Types;
                else if (IsCollectionType(field.PropertyType)) return ArgumentTypes.MultipleUnique;
                else return ArgumentTypes.AtMostOnce;
            }
            ...
            class Argument
            {
                ...
                bool ReportMissingRequiredArgument()
                {
                    ...
                    {
                        if (this.IsDefault) reporter(String.Format(CultureInfo.InvariantCulture, "Missing required argument '<{0}>'.", this.LongName));
                        else reporter(String.Format(CultureInfo.InvariantCulture, "Missing required argument '/{0}'.", this.LongName));
                        return true;
                    }
                    return false;
                }
                ...
                public bool SetValue(string value, object destination)
                {
                    ...
                    object newValue;
                    if (!ParseValue(this.ValueType, value, out newValue)) return false;
                    if (this.IsCollection)
                    {
                ...
                public bool IsRequired
                {
                    get
                    {
                        return 0 != (this.flags & ArgumentTypes.Required);
                    }
                }
                ...
                public bool AllowMultiple
                {
                    get
                    {
                        return 0 != (this.flags & ArgumentTypes.Multiple);
                    }
                }
                ...
                public bool Unique
                {
                    get
                    {
                        return 0 != (this.flags & ArgumentTypes.Unique);
                    }
                }
